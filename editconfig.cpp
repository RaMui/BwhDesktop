...
EditConfig::EditConfig(BwhDesktop *b, QWidget *parent)
    : QDialog(parent)
    , ui(new Ui::EditConfig), bwhDesktop(b)
{
    ui->setupUi(this);
    connect(ui->buttonBox, &QDialogButtonBox::accepted, this, &EditConfig::deleteFun);
