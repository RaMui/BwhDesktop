...
BwhDesktop::BwhDesktop(QWidget *parent)
    : QMainWindow(parent)
    , ui(new Ui::BwhDesktop), timer(new QTimer(this))
{
    ui->setupUi(this);
    manager = new QNetworkAccessManager(this);

    AddConfig* addConfig = new AddConfig(this, this);
    connect(ui->config_create, &QAction::triggered, addConfig, &QDialog::open);

    EditConfig* editConfig = new EditConfig(this, this);
...
void BwhDesktop::loadDataJson(QJsonObject& jsonObject)
{
    ...
    ui->bandwidth_usage_value->setText(QString::number(counter, 'f', 2) + "/" + QString::number(monthly_data, 'f', 0) + " GB");
